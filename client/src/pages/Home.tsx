...
export default function Home() {
  ...
  const [selectedGoals, setSelectedGoals] = useState<Goal[]>([
    ...
    { id: "2", text: "Тренировка 30 минут", done: true },
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black">
      ...
      <div className="max-w-6xl mx-auto mt-28 px-6 flex flex-col gap-4">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex justify-center">
                <div className="scale-[1.45] origin-bottom px-4 py-3">
                    <CalendarSection onSelectDay={(day) => {
                      setSelectedDay(day);
            ...
            <div className="bg-white/5 backdrop-blur-2xl border border-white/30 rounded-3xl p-8 my-10">
              ...
              <button onClick={addGoal} className="mt-6 w-full py-4 bg-green-500/20 border-2 border-dashed border-green-500/50 rounded-2xl text-green-400 font-medium hover:bg-green-500/30 transition flex items-center justify-center gap-3">
        ...
        {isDayModalOpen && (
          <DayModal date={selectedDay} onClose={() => setIsDayModalOpen(false)}/>
        )}
