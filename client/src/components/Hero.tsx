...
function Hero() {
  return (
    <>
    <div id="hero" className="hero-section flex flex-col relative min-h-screen justify-center items-center">
      <h1 className="text-6xl font-bold text-white mb-2">
        ...
        <div className='text-white flex justify-center gap-7 my-4'>
            ...
            <button className='px-4 py-2 rounded-2xl bg-white text-black font-bold hover:bg-green-500 transition flex items-center gap-1'>
              Начать бесплатно
              <BiRightArrowAlt />
            </button>
