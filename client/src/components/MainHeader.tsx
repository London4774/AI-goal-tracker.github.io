...
const dropdownItems = [
  { name: "Профиль", logo: <FaUser />, link: "/profile" },
  { name: "Настройки", logo: <FaCog />, link: "/settings" },
  { name: "Выход", logo: <FaDoorOpen />, link: "/" },
];
        ...
        <div className="flex justify-between items-center gap-8 text-white">
          ...
          <div className="relative">
            ...
            <div className="absolute">
              {isOpen && (
                <ul className="bg-black border border-white min-w-35 rounded-sm px-2">
